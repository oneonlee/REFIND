...
python model/baseline_model.py --mode train --model_checkpoint $output_path --data_path $data_path --pred_path $pred_path --test_lang $test_lang

# To get predictions from a trained model:
python model/baseline_model.py --mode test --model_checkpoint "$model_checkpoint" --data_path $data_path --pred_path $pred_path --test_lang $test_lang
